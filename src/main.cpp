...
uint256 hashGenesisBlock("0x06ab10c98e64af9805c8faa99d42cd00e493c8af99742301ecdbb198d436ca34");
...
const string strMessageMagic = "EsanCoin Signed Message:\n";
...
{
    int64 nSubsidy = 20 * COIN; //Amt of coins per block

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 5 * 60 * 60; // EsanCoin: 0.35 days    // TIEMPO EN REAJSUTAR LA DIFICULTAD DE LA MINERIA / ES PROPORCIONAL AL NUMERO DE MONEDAS EXISTENTES
static const int64 nTargetSpacing = 10; // EsanCoin: 10 seconds
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal EsanCoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "EsanCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
	...
	CBlock(hash=14dc23f54de47df79717, PoW=00000aeb1f05fbf0b2fa, ver=1, 			hashPrevBlock=00000000000000000000, hashMerkleRoot=ef7e256a2c, 			nTime=1399574511, nBits=1e0ffff0, nNonce=2086299649, vtx=1)
  	...
  	vMerkleTree: ef7e256a2c */
        ...
        // Genesis block
        const char* pszTimestamp = "primer dia de EsanCoin";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1549903882;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2088851756;
        ...
        assert(block.hashMerkleRoot == uint256("0x83fa7635f8acaa7a56c3960684ae4cd9aeddf4f9e661d6cb022648d0e0bbce20"));
